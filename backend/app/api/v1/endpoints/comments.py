...
async def read_comment_by_id(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Internal server error while fetching comment",
        ) from e
...
async def reply_to_comment(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Internal server error while replying to comment",
        ) from e
...
async def read_replies_to_comment(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Internal server error while fetching comment replies",
        ) from e
